...
using App.Data.API;
using App.Helpers.HttpMessageHandlers;
...
namespace App
{
    public static class Startup
    {
        ...
        private const string SERVICES_NAMESPACE = "App.Services";
        //private const string SINGLE_INSTANCE_SERVICES_NAMESPACE = "App.Services.SingleInstance";
        private const string VIEW_MODELS_NAMESPACE = "App.ViewModels";
        ...
        static Startup()
        {
            ...
            serviceCollection.AddRefitClient<IGastosViajeApi>(refitSettings)
                .ConfigureHttpClient(c => c.BaseAddress = new Uri(Settings.ApiBaseUri))
                .AddHttpMessageHandler<BaseAddressHandler>();

            serviceCollection.AddRefitClient<IIngresarGastosApi>(refitSettings)
                .ConfigureHttpClient(c => c.BaseAddress = new Uri(Settings.ApiBaseUri))
                .AddHttpMessageHandler<BaseAddressHandler>();
